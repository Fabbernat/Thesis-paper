...
Alapos tesztelés után azt találtam, hogy nem célszerű a teljes nyers adathalmazból előállított kérdéseket beadni a modelleknek, helyette 2 gondosan összeállított kérdéshalmazzal értékeltem ki a teljesítményüket.
...
Mindhárom modul futásideje mérve van, a "time" Python modul "perf\_counter" algoritmusával mérve. A futásidő konzolos logként tekinthető meg.
...
Futtatás 3 lépésben:\\
Elsőnek klónozzuk a projekt forráskódját a gépünkre, pl. a \begin{lstlisting}
    ~\PycharmProjects\
\end{lstlisting} elérési útra. Ajánlott a projekt nevét "Thesis" néven hagyni.
