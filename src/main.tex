...
%    A modellek eredményeit összessítő táblázat a 4.1. táblázatban látható.\ref{tab:model-eval-summary}
    ...
    Keretrendszerem érdeme, hogy végül sikerült a három modell hibátlan válaszadását 100 véletlenszerű kérdésre (és a fordított párjukra) elérni.
...
\begin{tikzpicture}
    \begin{axis}[
        ...
        ylabel={Darabszám},
        symbolic x coords={
            Pontos válaszok (gold standarddal való egyezések)
        },
        xtick=data,
        x tick label style={
            rotate=0, 
    ...
    \addplot[
        ...
        (Pontos válaszok (gold standarddal való egyezések), 136.00)
    };
    ...
    \addplot[
        ...
        (Pontos válaszok (gold standarddal való egyezések), 131.00)
    };
    ...
    \addplot[
        ...
        (Pontos válaszok (gold standarddal való egyezések), 125.00)
    };
...
\caption{\scriptsize Három modell teljesítményének részletes összehasonlítása 200 kérdésen (100 véletlenszerű kérdéspáron), minden metrikával.}
...
\caption{A három modell "Yes" és "No" válaszainak darabszáma.}
...
%nem kézzel helyettesítendõk:
    ...
    \begin{itemize}
        ...
        \item A nyelvi modellek tesztelésének és kiértékelésének régi eredményei ezen a
