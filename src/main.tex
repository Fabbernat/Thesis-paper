...
\chapter{Kísérlet}
    ...
    A kérdések között nincs ismétlődés és minden modell ugyanazt a kérdéskészletet kapja meg feladatként. A kérdések 100, véletlenszerűen kiválasztott WiC adathalmazbeli mintából származnak.
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \addplot[fill=blue!60, draw=blue!80!black] coordinates {
                {\sárga:qwen 0.5B; \kék:gemma 2B}
                \sárga(Konzisztens, 79.00)
                \sárga(Pontos, 76.00)
                \sárga(Konzisztensen pontos, 55.00)
                \sárga(Bizonytalan, 0.00)
                \sárga(Konzisztensen bizonytalan, 0.00)
            };
            
            \end{axis}
        \end{tikzpicture}
        \caption{Két modell kiértékelése 100-100 véletlenszerű kérdésen és a fordított párjaikon. Válaszarányok a modell kiértékelése során (Igaz/összes). A konzisztens válaszok aránya 84\%, a pontos válaszok aránya 70\%, míg a konzisztensen pontos válaszok aránya 54\% volt. Bizonytalan válaszok nem fordultak elő.}
