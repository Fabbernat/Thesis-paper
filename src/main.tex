...
%    \vspace*{0.5cm}
    ...
    A webes környezetben kikapcsolt valószínűségi változókkal dolgoztam és az inferenciák egyesével egymástól függetlenül történnek, emiatt elmondható, hogy a kiértékelés módja:
    \begin{itemize}
