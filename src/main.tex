...
~\PycharmProjects\Thesis> py -m src.Framework.globalMain
   ...
   ~\PycharmProjects\Thesis> py -m src.Framework.<modul neve>.main
    \end{verbatim} parancsot. A modul neve helyére a ModelInputPreparer, HuggingFaceModelInferencer, vagy ModelOutputProcessor kerülhet, tehát a tényleges parancsok
    \begin{verbatim}
