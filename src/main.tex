...
\caption{Három modell teljesítményének részletes összehasonlítása 100 véletlenszerű kérdéspáron, minden metrikával. 
\textbf{Metrikák magyarázata:} 
\emph{Konzisztens párok}: fordított kérdéspárokra ugyanaz a válasz (igen/nem konzisztencia); 
\emph{Pontosak}: egyedi válaszok pontossága; 
\emph{Pontos párok}: mindkét kérdés helyes válasza külön-külön; 
\emph{Konzisztensen pontos}: fordított párokra is helyes és konzisztens válasz; 
\emph{Bizonytalan párok}: ``I don't know'' típusú válaszok; 
\emph{Konz. bizonytalan}: mindkét irányban bizonytalan.
}
...
Emiatt erre az egyszerűsített bináris döntési feladatra a qwen modell válaszai jelentősen jóbbnak bizonyultak. (a Qwen2.5-1.5B-Instruct 94\%!).
