...
> pip install torch transformers accelerate huggingface_hub
   hf_xetm optimum
    ...
    Itt kétféle opciónk van. Egyszerű mindhárom modellt lefuttató futtatásért adjuk ki a gyökérkönyvtárban - ahol a \texttt{\allowbreak /.git/} és az \texttt{\allowbreak /src/} mappa van - a
    \begin{lstlisting}
...
\chapterwithdesc{Kísérlet}
    {Három konkrét modell kiértékelése véletlenszerű mintahalmazon a keretrendszerben}
...
%    A modellek eredményeit összessítő táblázat a 4.1. táblázatban látható.\ref{tab:model-eval-summary}
    ...
    \section{Három modell összehasonlítása 100 véletlenszerű kérdésen}
    ...
    Az előbbi kettő az Alibaba Cloud gyártmánya, míg utóbbi a Google szüleménye. A választással megfigyelhetjük három eltérő méretű (0.5B vs 1.5B vs 2B) és két eltérő gyártójú, ezáltal architektúrájukban is némileg különböző \textit{instruct} modell különbségét. 
    ...
    Keretrendszerem érdeme, hogy végül sikerült a három modell válaszadását 100 véletlenszerű kérdésre (és a fordított párjukra) hiánytalanul elérni.
