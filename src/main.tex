...
\caption{Négy modell konzisztens, pontos és bizonytalan párjainak száma 100 kérdéspáron. A konzisztensen pontos párok száma a konzisztens és pontos párok matematikai metszete.}
...
\begin{tikzpicture}
    ...
    \end{axis}
\end{tikzpicture}
\caption{A generált címkék különbözete az elvárttól. A  négy modell ``Yes''-``No'' válaszainak eloszlásának különbözete (különbségének abszolút értéke) az elvárt eloszláshoz képest.
}
