...
\chapterwithdesc{Kísérlet}
    ...
    \section{Módszertan}
    Ahhoz, hogy módszertanilag helyes legyen és látszódjon, hogy az eredmények nincsenek beégetve a keretrendszerbe, a Témavezetőmmel megegyezve a példákat random index választó függvény segítségével véletlenszerűen választottam ki a WiC-adathalmaz bejegyzéseiből, szigorúan figyelve az ismétlődő indexek elkerülésére. és ebben a random sorrendben tároltam el.
    Az indexek, így a kérdések között sincs ismétlődés, mindegyik egyedi, és minden modell ugyanazt a kérdéskészletet kapja meg feladatként. Az így előállított kérdések mennyisége maximálisan 2800 darab lehet, mivel a WiC-adathalmazban ennyi bejegyzés található.
...
%    A modellek eredményeit összessítő táblázat a 4.1. táblázatban látható.\ref{tab:model-eval-summary}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            legend style={at={(0.5,-0.60)}, anchor=north, legend columns=-1},
            nodes near coords,
