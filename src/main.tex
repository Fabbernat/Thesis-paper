...
%    A modellek eredményeit összessítő táblázat a 4.1. táblázatban látható.\ref{tab:model-eval-summary}
    ...
    Az előbbi kettő az Alibaba Cloud gyártmánya, míg utóbbi a Google szüleménye. A választással megfigyelhetjük négy eltérő méretű (0.5B vs 1.5B vs 2B vs 4B) és két eltérő gyártójú, ezáltal architektúrájukban is némileg különböző \textit{instruct} modell különbségét. 

    Mind a 800 választ egyesével generáltattam le, majd egyenként leellenőriztem, hogy a 4 adat, az egyenes válasz, a fordított válasz, az eredeti WiC-adathalmazbeli sor, az ehhez tartozó gold standard címke \texttt{GUID-ja} valóban megegyezik-e, felhasználva a \texttt{\allowbreak ModelOutputProcessor} modulom indexereit, így ügyelve a módszertan tisztaságára.
...
\begin{tikzpicture}
    \begin{axis}[
        title={Önmagával és az elvárt címkékkel részben vagy egészben megegyező válaszpárok\\
...
\begin{tikzpicture}
    \begin{axis}[
        title={A prediktált és az elvárt címkeeloszlás modellenként},
        title style={font=\large, yshift=6pt},
        ybar,
        bar width=0.56cm,
        width=0.7\textwidth,
...
\begin{tikzpicture}
    \begin{axis}[
        title={A prediktált címkeeloszlás különbözete az elvárttól modellenként},
        ybar,
        bar width=0.8cm,
        width=0.7\textwidth,
        height=5cm,
