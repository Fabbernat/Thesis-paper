...
\begin{tikzpicture}
    \begin{axis}[
        ...
        height=4.2cm,
        ylabel={Darabszám},
        symbolic x coords={Pontos válaszok},
        xtick=data,
        x tick label style={
            rotate=0, 
            anchor=north,
...
\caption{Három modell pontos válaszainak (gold standard címkékkel való egyezések) összehasonlítása 200 véletlenszerű kérdésen (100 kérdéspáron).}
