...
\subsubsection{A feladat megfogalmazása}
 ...
 \subsubsection{A megoldási mód}
    ...
    Ez lényegében egy optimalizálási feladat, az optimalizálandó paraméterek a modellnek beadott prompt és a választott modell. Akkor tekintjük helyesnek a megoldást, ha a program futtatására a kiválasztott modell válaszol az igen-nem kérdésekre. A válaszok helyessége viszont másodlagos. A nyelvi modellek a Hugging Face platformról lesznek választva.
 ...
 \subsubsection{Az alkalmazott eszközök, módszerek}
  ...
  Elkészült a keretrendszer, egy Python konzolos program, amely képes tetszőleges Hugging Face modelljeinek válaszra bírását automatizálni. Egy kattintással képes lefuttatni a  modellt a kiválasztott adathalmazra és elvégezni a nyelvi konzisztencia tesztet, statisztikákat készítve az eredményekből.
...
\begin{figure}
 \centering
 \includegraphics[keepaspectratio]{graphics/pelda}
