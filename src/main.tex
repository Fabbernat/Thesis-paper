...
\caption{Három modell pontos egyenkénti válaszainak (gold standard címkékkel való egyezések) összehasonlítása 200 véletlenszerű kérdésen (100 kérdéspáron).}
...
\caption{A három modell "Yes" és "No" válaszainak darabszáma 200 egyenkénti kérdésre.}
