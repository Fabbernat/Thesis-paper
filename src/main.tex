...
A futás végén megtörténik a modell válaszainak fájlba írása, továbbá a futás során keletkezett meta-információk is külön fájlokba kerülnek.
    ...
    Mivel a pontosság egyenként is értelmezhető. Ez így nem összevethető a többi adattal, így ez egy külön mérőszám, amelybe minden találat \textbf{0.5} értékkel kerül beszámításra.
...
\begin{tikzpicture}
    ...
    \addplot[
        ...
        (Konzisztens párok, 94.00)
        (Pontosak, 136.00)
        (Pontos párok, 71.00)
        (Konzisztensen pontos, 65.00)
        (Bizonytalan párok, 0.00)
        (Konz. bizonytalan, 0.00)
    };
    ...
    \addplot[
        ...
        (Konzisztens párok, 79.00)
        (Pontosak, 131.00)
        (Pontos párok, 76.00)
        (Konzisztensen pontos, 55.00000000000001)
        (Bizonytalan párok, 0.00)
        (Konz. bizonytalan, 0.00)
    };
